        ...
        e.extend(e.Widget.prototype, {
            _getCreateOptions: function() {
                ...
                if (!e.mobile.getAttribute(s, "defaults"))
                    for (t in this.options) i = e.mobile.getAttribute(s, t.replace(n, r)), i != null && (o[t] = i);
                return o
            }
        ...
        e.mobile.ajaxBlacklist && (e.mobile.ajaxEnabled = !1), i.addClass("ui-mobile ui-mobile-rendering"), setTimeout(o, 5e3), e.extend(e.mobile, {
            initializePage: function() {
                var t = e.mobile.path,
                    ...
                    u = t.stripHash(t.stripQueryParams(t.parseLocation().hash)),
                    a = e.mobile.path.parseLocation(),
                    f = u ? n.getElementById(u) : r;
                ...
                }), e.mobile.firstPage = i.first(), e.mobile.pageContainer = e.mobile.firstPage.parent().addClass("ui-mobile-viewport").pagecontainer(), e.mobile.navreadyDeferred.resolve(), s.trigger("pagecontainercreate"), e.mobile.loading("show"), o(), !e.mobile.hashListeningEnabled || !e.mobile.path.isHashValid(location.hash) || !e(f).is(":jqmData(role='page')") && !e.mobile.path.isPath(u) && u !== e.mobile.dialogHashKey ? (e.event.special.navigate.isPushStateEnabled() && e.mobile.navigate.navigator.squash(t.parseLocation().href), e.mobile.changePage(e.mobile.firstPage, {
                    transition: "none",
                    reverse: !0,
                    changeHash: !1,
                    fromHashChange: !0
    ...
    function(e, t) {
        e.widget("mobile.button", {
            ...
            refresh: function(t) {
                ...
                this.options.icon && this.options.iconpos === "notext" && this.element.attr("title") && this.element.attr("title", this.element.val()), t || (n = this.element.detach(), e(this.wrapper).text(this.element.val()).append(n)), this.options.disabled !== r && this._setOptions({
                    disabled: r
                })
            }
        })
        ...
        e.widget("mobile.checkboxradio", e.extend({
            ...
            refresh: function() {
                var t = this.element[0].checked,
                    ...
                    r = "ui-btn-icon-" + this.options.iconpos,
                    i = [],
                    s = [];
        ...
        e.widget("mobile.slider", e.extend({
            ...
            _create: function() {
                var i = this,
                    ...
                    x = e(S),
                    T = this.options.highlight && !c ? function() {
                ...
                }), x.insertAfter(s), !c && !h && (C = this.options.mini ? "<div class='ui-slider ui-mini'>" : "<div class='ui-slider'>", s.add(x).wrapAll(C)), this._on(this.handle, {
            ...
            refresh: function(t, r, i) {
                var s = this,
                    ...
                    p, d, v, m, g, y, b, w, E, S, x, T, N, C, k, L, A, O, M, _;
        ...
        e.widget("mobile.popup", {
            ...
            _create: function() {
                var t = this.element,
                    n = t.attr("id"),
                    r = this.options;
                r.history = r.history && e.mobile.ajaxEnabled && e.mobile.hashListeningEnabled, this._on(this.document, {
            ...
            _desiredCoords: function(t) {
                var n, r = null,
                    ...
                    a = t.positionTo;
                if (a && a !== "origin")
                    if (a === "window") o = s.cx / 2 + s.x, u = s.cy / 2 + s.y;
                    else {
                        try {
                            r = e(a)
                        } catch (f) {
